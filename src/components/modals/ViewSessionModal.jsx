                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {homeworks.map(hw => (
                      <div
                        key={hw.id}
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 bg-slate-900 rounded-xl border border-slate-700"
                      >
                        ...
                        <button
                          ...
                          className="text-sm px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-colors font-medium whitespace-nowrap w-full sm:w-auto"
                        >
                          View Task
                        </button>
                      </div>
